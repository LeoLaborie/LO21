    ...
    : QGraphicsPolygonItem(nullptr)
{
    ...
    switch (modele->getType())
    {
        case TypeHex::PHabitation:
            imgFile = "placeHabitation.png";
            break;
        case TypeHex::PMarche:
            imgFile = "PlaceMarche.png";
            break;
        case TypeHex::PTemple:
            imgFile = "PlaceTemple.png";
            break;
        case TypeHex::PCaserne:
            imgFile = "PlaceCarserne.png";
            break;
        case TypeHex::PJardin:
            imgFile = "PlaceJardin.png";
            break;
        case TypeHex::Habitation:
            imgFile = "Habitation.png";
            break;
        case TypeHex::Marche:
            imgFile = "Marche.png";
            break;
        ...
        case TypeHex::Caserne:
            imgFile = "Carserne.png";
            break;
        case TypeHex::Jardin:
            imgFile = "Jardin.png";
            break;
        case TypeHex::Carriere:
            imgFile = "Carriere.png";
            break;
        default:
            imgFile = "placeHabitation.png";
            break;
